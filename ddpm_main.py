...
def parse_args_and_config():
    ...
    parser.add_argument(
        "--config", type=str, default="/media/super/DATA/tianxiao/Fast-DDPM_laplas/configs/brats_linear.yml", help="Path to the config file"
    )
    parser.add_argument(
        "--dataset", type=str, default="BRATS", help="Name of dataset(LDFDCT, BRATS, PMUB)"
    )
    ...
    try:
        ...
        if args.sample:
            if args.dataset=='PMUB':
                runner.sr_sample()
            elif args.dataset=='IXI' or args.dataset=='BRATS'or args.dataset=='pelvic' or args.dataset=='BRATS2024':
                runner.sg_sample()
            else:
            ...
            if args.dataset=='PMUB':
                runner.sr_ddpm_train()
            elif args.dataset=='IXI' or args.dataset=='BRATS'or args.dataset=='pelvic' or args.dataset=='BRATS2024':
                runner.sg_ddpm_train()
            else:
