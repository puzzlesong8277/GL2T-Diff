...
def parse_args_and_config():
    ...
    parser.add_argument(
        "--config", type=str, default="/media/super/DATA/tianxiao/Fast-DDPM-main/configs/brats_linear.yml", help="Path to the config file"
    )
    parser.add_argument(
    ...
    try:
        ...
        if args.sample:
            if args.dataset=='PMUB':
                runner.sr_sample()
            elif args.dataset=='IXI' or args.dataset=='BRATS'or args.dataset=='pelvic':
                runner.sg_sample()
            else:
